...
**Do NOT use this skill for:** reviewing PR comments (use `pr-review`), creating a PR (use `sprint`), planning a project.
...
2. `npm run format:check` (or equivalent)
3. `npm run test` (or equivalent)
4. `npm run build` (or equivalent)
